...
UsuarioSchema.methods.toJSON=function(){ //esto es que cuando se mande a ejecutar el metodo del Schema toJson, 
                                        //va a ejecutar eso, aqui en este modelos y de esta manera podemos reemplazar el contenido de cualquier funcion de mongoose
    const{__v,password,...usuario}=this.toObject() //de esta forma quita los dos primeros atributos y guarda en usuario todo el resto
    return usuario
